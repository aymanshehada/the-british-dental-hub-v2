  ...
  },
  {
    ...
    arContent: {
      ...
      content: [
        ...
        { type: 'table', headers: ['الاعتبار', 'التبييض', 'الفينير'], rows: [
          ...
          ['يُنظر فيه عادةً حين', 'يكون الشاغل الأساسي هو اللون، وشكل السن مقبول بالفعل', 'يتجاوز الشاغل اللون إلى الشكل أو التناسب'],
        ] },
